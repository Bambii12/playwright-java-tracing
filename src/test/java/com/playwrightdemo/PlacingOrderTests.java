...
public class PlacingOrderTests extends PlaywrightBaseTest {

    @Test
    public void submitOrderTest() {

        double price = 10.5;
        String username = "success@reqr.es";
        ...
        assertThat(page.locator("#orderMessage")).hasText("Order placed by " + fullName + "! Total amount: $" + price);
    }
}
